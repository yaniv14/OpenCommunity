tinymce.ThemeManager.add("modern", function (a) {
    ...
    l.renderUI = function (b) {
        ...
        if (c) {
            var d = m.skin_url;
            if (OCD.language == 'he') {
                d = d ? a.documentBaseURI.toAbsolute(d) : tinymce.baseURL + "/skins/" + c, tinymce.Env.documentMode <= 7 ? b.skinUiCss = d + "/skin.ie7.min.css" : b.skinUiCss = d + "/skin_rtl.min.css", a.contentCSS.push(d + "/content" + (a.inline ? ".inline" : "") + "_rtl.min.css")
            } else {
